...
# 加载预测和真值数据
pred_path = f"/root/autodl-tmp/medical/results/Tseg/ct_seg/Dataset102_CT_114/s0114.nii.gz"
pred_path_3d_fullres = "/root/autodl-tmp/medical/results/Tseg/nnunet/Dataset102_CT_114/s0114.nii.gz"
gt_path = f"/root/autodl-tmp/medical/data_try/Dataset102_CT_114/nnUNet_raw/Dataset102_CT_114/labelsTr/s0114.nii.gz"
output_dir = "/root/autodl-tmp/vis/cp/Dataset102_CT_114"
...
ax[0].set_title(f"Totalseg Slice{slice_idx + 1}")
ax[0].axis('off')
...
ax[2].set_title(f"nnunet Slice {slice_idx + 1}")
ax[2].axis('off')
