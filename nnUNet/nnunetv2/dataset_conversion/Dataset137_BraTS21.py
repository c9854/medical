...
if __name__ == '__main__':
    brats_data_dir = '/root/autodl-tmp/medical/data_all/data_GLI/ASNR-MICCAI-BraTS2023-GLI-Challenge-TrainingData'
    ...
    case_ids = subdirs(brats_data_dir, prefix='BraTS', join=False)[50:51]
    ...
    for c in case_ids:
        ...
        copy_BraTS_segmentation_and_convert_labels_to_nnUNet(join(brats_data_dir, c, c + "-seg.nii"),
                                                             join(labelstr, c + '.nii.gz'))

    generate_dataset_json(out_base,
                          channel_names={0: 't1n', 1: 't1c', 2: 't2f', 3: 't2w'},
                          labels={
                              'background': 0,
                              'whole tumor': (1, 2, 3),
                              'tumor core': (2, 3),
